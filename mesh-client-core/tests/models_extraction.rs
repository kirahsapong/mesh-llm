use mesh_client_core::models::capabilities::ModelCapabilities;
use mesh_client_core::models::catalog::MODEL_CATALOG;
use mesh_client_core::models::gguf::scan_gguf_compact_meta;
...
fn gguf_parse_minimal_fixture() {
    ...
    let tmp = std::env::temp_dir().join("mesh-client-core-models-extraction.gguf");
