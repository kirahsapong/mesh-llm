...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_mesh_ffi_checksum_func_create_client() != 44334.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_cancel() != 27338.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_chat() != 32798.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_disconnect() != 49378.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_join() != 60918.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_list_models() != 47189.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_reconnect() != 11257.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_responses() != 13271.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_meshclienthandle_status() != 11480.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mesh_ffi_checksum_method_eventlistener_on_event() != 46383.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public object FfiConverterTypeFfiError : FfiConverterRustBuffer<FfiException> {
    override fun read(buf: ByteBuffer): FfiException {
            ...
            2 -> FfiException.JoinFailed(FfiConverterString.read(buf))
            3 -> FfiException.DiscoveryFailed(FfiConverterString.read(buf))
            4 -> FfiException.StreamFailed(FfiConverterString.read(buf))
            5 -> FfiException.Cancelled(FfiConverterString.read(buf))
            6 -> FfiException.ReconnectFailed(FfiConverterString.read(buf))
